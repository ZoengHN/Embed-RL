...
from verl.third_party.vllm.qwen3_vl_patch import apply_qwen3_vl_lora_patch
...
# Apply Qwen3-VL LoRA filtering patch for vLLM 0.11.0+
apply_qwen3_vl_lora_patch()
